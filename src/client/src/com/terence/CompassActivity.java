...
public class CompassActivity extends Activity implements SensorEventListener {
    ...
    private double totalacclerationmax;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		if(getIntent() != null){
			Bundle totalacclerationmaxBundle = getIntent().getExtras();		
			if(totalacclerationmaxBundle != null){
				totalacclerationmax = totalacclerationmaxBundle.getDouble("totalacclerationmax");
				System.out.println("Max accleration:" + totalacclerationmax );
...
private String getDirectionFromDegrees(float degrees) {
    ...
    public void returnToSendMessage(View v){
        Intent i = new Intent();  
        i.putExtra("totalacclerationmax", totalacclerationmax);
        i.putExtra("direction", directionView.getText().toString());
